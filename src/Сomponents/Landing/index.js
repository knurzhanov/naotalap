...
const Landing = () => {
    const newsItems = [
        ...
        },
        {
          ...
          title: 'Бизнес пен білім беру процесін интеграциялау үшін өңірлік білім беру-өндірстік кластерін құруға ұсынымдар',
          description:
        ...
        },
        {
          ...
          description:
            'Басты міндет – жас буынның жұмысшы мамандықтарын саналы түрде таңдап, еліміздің экономикасына оң әсерін тигізетін білікті азаматтар болып қалыптасуына жағдай жасау....',
          date: '16.05.2025',
        },
      ];
 return(
